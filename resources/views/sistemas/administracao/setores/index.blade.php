...
<div class="row">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-1">
                <a href="{{ route('sistemas.administracao.setores') }}" class="text-body">
                    <i class="icon-base ti tabler-hierarchy-3 icon-22px mb-1"></i>
                </a>
                Setores
            </h4>
            <p class="mb-0">Gerenciamento de estrutura setorial</p>
        </div>
