...
<div class="row">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-1">
                <a href="{{ route('sistemas.administracao.autorizacoes') }}" class="text-body">
                    <i class="icon-base ti tabler-arrow-autofit-right icon-22px mb-1"></i>
                </a>
                Autorizações
            </h4>
            <p class="mb-0">Sistema interno de solicitações</p>
        </div>
