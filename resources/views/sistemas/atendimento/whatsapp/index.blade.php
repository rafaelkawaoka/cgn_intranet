        ...
        <div class="app-chat card overflow-hidden">
            <div class="row g-0">
                    ...
                    <div class="sidebar-body px-6 pb-6">
                        <div class="my-6">
                            <div class="maxLength-wrapper">
                                ...
                                <textarea id="chat-sidebar-left-user-about" class="form-control chat-sidebar-left-user-about maxLength-example" rows="3" maxlength="120">
                    ...
                    <div class="sidebar-header h-px-75 px-5 border-bottom d-flex align-items-center">
                        <div class="d-flex align-items-center me-6 me-lg-0">
                            ...
                            <div class="flex-grow-1 input-group input-group-merge">
                                ...
                                <input type="text" class="form-control chat-search-input" placeholder="Pesquisar..." aria-label="Search..." aria-describedby="basic-addon-search31" />
                            </div>
                        </div>
                        ...
                        <div class="sidebar-body">
                            <ul class="list-unstyled chat-contact-list py-2 mb-0" id="chat-list">
                                <li class="chat-contact-list-item chat-contact-list-item-title mt-0">
                                    <h5 class="text-primary mb-0">Pendentes</h5>
                                </li>
                            ...
                            <ul class="list-unstyled chat-contact-list mb-0 py-2" id="contact-list">
                                <li class="chat-contact-list-item chat-contact-list-item-title mt-0">
                                    <h5 class="text-primary mb-0">Recentes</h5>
                                </li>
                ...
                <div class="col app-chat-conversation d-flex align-items-center justify-content-center flex-column" id="app-chat-conversation">
                    ...
                    <p class="my-4">Selecione um contato para visualizar a conversa.</p>
                    ...
                    <div class="chat-history-wrapper">
                        <div class="chat-history-header border-bottom">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex overflow-hidden align-items-center">
                                    ...
                                    <div class="chat-contact-info flex-grow-1 ms-4">
                                        <h6 class="m-0 fw-normal">Nome do Consulente</h6>
                                        <small class="user-status text-body">080 0000 0000</small>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <span class="btn btn-text-secondary cursor-pointer d-sm-inline-flex d-none me-1 btn-icon rounded-pill" title="Resposta modelo">
                                        <i class="icon-base ti tabler-message-circle-star icon-22px"></i>
                                    </span>
                                    <span class="btn btn-text-secondary cursor-pointer d-sm-inline-flex d-none me-1 btn-icon rounded-pill" title="Adicionar etiqueta">
                                        <i class="icon-base ti tabler-tag-plus icon-22px"></i>
                                    </span>
                                    <span class="btn btn-text-secondary cursor-pointer d-sm-inline-flex d-none me-1 btn-icon rounded-pill" title="Ver cadastro">
                                        <i class="icon-base ti tabler-user-square icon-22px"></i>
                                    </span>
                                    <span class="btn btn-text-secondary cursor-pointer d-sm-inline-flex d-none me-1 btn-icon rounded-pill" title="Exportar PDF">
                                        <i class="icon-base ti tabler-file-type-pdf icon-22px"></i>
                                    </span>
                                    <span class="btn btn-text-secondary cursor-pointer d-sm-inline-flex d-none me-1 btn-icon rounded-pill" title="Concluir atendimento">
                                        <i class="icon-base ti tabler-checkbox icon-22px"></i>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="chat-history-footer shadow-xs">
                            <form class="form-send-message d-flex justify-content-between align-items-center ">
                                <input class="form-control message-input border-0 me-4 shadow-none" placeholder="Digite sua mensagem aqui..." />
